...
const featuredProducts = [
  {
    id: '1',
    title: 'Bushcraft Knife with Leather Sheath',
    category: 'Knives',
    image: '/images/products/bushcraft-knife-1.jpg',
    description: 'Full tang knife perfect for camping and bushcraft. High carbon steel with comfortable grip.',
  ...
  },
  {
    ...
    title: 'Camp Hatchet',
    category: 'Hatchets',
    image: '/images/products/camp-hatchet-1.jpg',
    description: 'Lightweight camp hatchet for splitting kindling and general camp tasks.',
    etsyUrl: SITE_CONFIG.etsyShopUrl,
  },
  {
    id: '3',
    title: 'Traditional C-Striker',
    category: 'Strikers',
    image: '/images/products/c-striker-1.jpg',
    description: 'Hand-forged fire striker for primitive fire starting with flint.',
    etsyUrl: SITE_CONFIG.etsyShopUrl,
  },
  {
    id: '4',
    title: 'Celtic Steel Knot',
